...
import { Users, Edit3, Globe, Lock, UserPlus, X, Check } from "lucide-react";
    ...
    <form onSubmit={handleSubmit} className="pt-6">
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          {/* Descrição */}
          <div
            className="space-y-4 p-5 rounded-2xl transition-all duration-200 hover:scale-[1.01] h-full"
            style={{ backgroundColor: "#7a5f23" }}
          >
            <div className="flex items-center gap-2">
      ...
      <div className="flex gap-3 justify-end pt-6 border-t border-white/10 mt-6">
        ...
        <Button
          ...
          style={{
            backgroundColor: isLoading || !name.trim() ? "#6b5420" : "#5e4318",
          }}
        >
          {isLoading ? (
            <>

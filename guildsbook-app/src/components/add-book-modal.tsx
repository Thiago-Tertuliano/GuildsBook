          ...
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <DialogDescription
                ...
                style={{ color: "#f5ead9" }}
              >
                Busque e selecione um livro para adicionar à sua biblioteca
                pessoal.
              </DialogDescription>
            </div>
          </div>
          ...
          >
            ...
            <div className="mb-4 sm:mb-6">
              ...
              {searchInput && !isSearching && (
                <p
                  className="text-xs sm:text-sm mt-2 ml-1"
                  style={{ color: "#e8d9b8" }}
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              {selectedBookId && (
                <div className="lg:col-span-1">
                  <div
                    className="space-y-3 sm:space-y-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl transition-all duration-200"
                    style={{ backgroundColor: "#7a5f23" }}
                  >
              ...
              <div
                className={`${selectedBookId ? "lg:col-span-2" : "lg:col-span-3"} space-y-4 sm:space-y-5`}
              >
                {isSearching && (
                  <div
                    className="py-12 flex justify-center items-center p-5 rounded-2xl"
                    style={{ backgroundColor: "#7a5f23" }}
                  >
                ...
                {!isSearching && books.length > 0 && (
                  <div
                    className="space-y-3 sm:space-y-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl"
                    style={{ backgroundColor: "#7a5f23" }}
                  >
                    ...
                    <div
                      className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-h-[400px] sm:max-h-[500px] overflow-y-auto rounded-lg sm:rounded-xl p-3 sm:p-4 scrollbar-thin"
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            {book.cover ? (
                              ...
                              <div
                                className="w-14 h-20 sm:w-16 sm:h-24 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md"
                                style={{ backgroundColor: "#6b5420" }}
                              >
                                <BookOpen
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="font-bold text-sm sm:text-base text-white line-clamp-2 mb-1">
                                {book.title}
                              </div>
                              <div
                ...
                {!searchInput && (
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base font-medium">
                      Comece digitando para buscar livros
                    </p>

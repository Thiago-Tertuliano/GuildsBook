  ...
  return (
    <form onSubmit={handleSubmit} className="pt-6">
      <div className="grid grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                style={
                  status === "QUERO_LER" ? { backgroundColor: "#5e4318" } : {}
                }
              >
                {status === "QUERO_LER" && (
        ...
        <div className="space-y-5">
          <div
            className="space-y-4 p-5 rounded-2xl h-full transition-all duration-200 hover:scale-[1.01]"
            style={{ backgroundColor: "#7a5f23" }}
          >
            <div className="flex items-center gap-2">
        ...
        <DialogHeader className="space-y-3 pb-6 border-b border-white/10">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm mt-1" style={{ color: "#e8d9b8" }}>

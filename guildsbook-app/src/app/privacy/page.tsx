...
export const metadata = {
  ...
  description:
    "Conheça como o GuildsBook coleta, usa e protege suas informações pessoais.",
};
        ...
        <div className="space-y-8">
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <p className="text-muted-foreground leading-relaxed">
              O GuildsBook respeita sua privacidade e está comprometido em
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  ...
                  <li>
                    Conteúdo que você publica (resenhas, citações, comentários)
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  ...
                  <li>
                    Informações do dispositivo (tipo, navegador, sistema
                    operacional)
                  </li>
          ...
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <li>
                Enviar recomendações de livros baseadas em suas preferências
              </li>
          ...
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>
                  <strong>Conteúdo público:</strong> Informações que você
                  escolhe tornar públicas (como resenhas e perfil)
                </li>
                <li>
          ...
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              criptografia, controle de acesso e monitoramento regular de
              segurança.
            </p>
          </section>
          ...
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              navegador, mas isso pode afetar a funcionalidade da plataforma.
            </p>
          </section>
          ...
          <section className="bg-gradient-to-br from-card via-card to-card/95 rounded-2xl p-8 shadow-lg border border-border/40">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>
                <strong>Acesso:</strong> Solicitar uma cópia das informações que
                temos sobre você
              </li>
              <li>
                <strong>Retificação:</strong> Corrigir informações imprecisas ou
                incompletas
              </li>
              <li>
